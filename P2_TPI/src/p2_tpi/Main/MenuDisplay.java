...
public class MenuDisplay {
    ...
    public static void vehiculoMenu() {
        System.out.println("\n----- MEN� VEH�CULOS -----");
        System.out.println("1) Crear Veh�culo + Seguro");
        System.out.println("2) Buscar por dominio");
        System.out.println("3) Listar todos");
        System.out.println("4) Eliminar (soft) Veh�culo + Seguro");
    ...
    public static void seguroMenu() {
        ...
        System.out.println("5) Buscar por número de póliza");
        System.out.println("0) Volver");
        System.out.print("Opción: ");
    }
    ...
    public static void coberturaMenu() {
        ...
        System.out.println("5) Buscar por c�digo");
        System.out.println("0) Volver");
        System.out.print("Opci�n: ");
    }
}
